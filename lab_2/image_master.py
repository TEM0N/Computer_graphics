...
root.configure(bg="#1abc9c")  # Светло-зеленый фон

frame_top = tk.Frame(root, bg="#16a085", height=100)
frame_top.pack(fill="x")

frame_left = tk.Frame(root, bg="#1abc9c", width=300)
frame_left.pack(side="left", fill="y")

frame_right = tk.Frame(root, bg="#1abc9c")
...
button_style = {
    "bg": "#e67e22",  # Оранжевый цвет кнопок
    "fg": "white",
...
title_label = tk.Label(frame_top, text="ImageMaster", bg="#16a085", fg="white", font=("Helvetica", 24, "bold"))
...
label_brightness = tk.Label(frame_left, text="Piecemeal operations and", bg="#1abc9c", fg="white", font=("Helvetica", 18))
label_brightness_lc = tk.Label(frame_left, text="Linear Contrast:", bg="#1abc9c", fg="white", font=("Helvetica", 18))
...
label_brightness_value = tk.Label(frame_left, text="Value:", bg="#1abc9c", fg="white", font=("Helvetica", 18))
label_brightness_value.grid(row=4, column=0, padx=(30, 0), pady=5, sticky="w")
...
label_simple_thresh = tk.Label(frame_left, text="Global Threshold Processing:", bg="#1abc9c", fg="white", font=("Helvetica", 18))
...
threshold_label = tk.Label(frame_left, text="Threshold:", bg="#1abc9c", fg="white", font=("Helvetica", 18))
threshold_label.grid(row=9, column=0, padx=(30, 0), pady=5, sticky="w")
...
label_save = tk.Label(frame_left, text="Saving:", bg="#1abc9c", fg="white", font=("Helvetica", 18))
label_save.grid(row=11, column=0, padx=5, pady=5)
